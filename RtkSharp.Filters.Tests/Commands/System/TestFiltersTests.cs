...
/// <summary>
/// Tests for <see cref="TestFilters"/>, the pure test-runner-output-summarizing logic behind
/// <c>rtk test</c>. Moved from <c>RtkSharp.Tests.Commands.System.TestCommandTests</c> when
/// <c>ExtractTestSummary</c> moved from <c>RtkSharp.Commands.System.TestCommand</c> to
/// <see cref="TestFilters"/> (Task 14 of the filters-library extraction). Faithful-port target:
/// Rust <c>runner::extract_test_summary</c> (<c>src/cmds/rust/runner.rs</c>:181-280). The
/// process-execution, output-capping, and tracking logic are not pure and remain in
/// <c>TestCommand</c> alongside its own tests.
/// </summary>
public sealed class TestFiltersTests
{
    // -----------------------------------------------------------------------
    ...
    public void ExtractTestSummary_Cargo_SummaryLineAndFailures()
    {
        ...
        var result = TestFilters.ExtractTestSummary(output, "cargo test");
    ...
    public void ExtractTestSummary_Pytest_SummaryAndFailures()
    {
        ...
        var result = TestFilters.ExtractTestSummary(output, "pytest -v");
    ...
    public void ExtractTestSummary_Jest_SummaryAndFailures_NpmTestAlias()
    {
        ...
        var result = TestFilters.ExtractTestSummary(output, "npm test");
    ...
    public void ExtractTestSummary_Jest_YarnTestAlias_AlsoDetected()
    {
        ...
        var result = TestFilters.ExtractTestSummary(output, "yarn test");
    ...
    public void ExtractTestSummary_Go_SummaryAndFailures()
    {
        ...
        var result = TestFilters.ExtractTestSummary(output, "go test ./...");
    ...
    public void ExtractTestSummary_NoEcosystemMatched_FallsBackToLastFiveLines()
    {
        ...
        var result = TestFilters.ExtractTestSummary(output, "make check");
    ...
    {
        var output = "line1\n\nline3\n";
        var result = TestFilters.ExtractTestSummary(output, "unknown-runner");
