...
/// <summary>
/// Tests for <see cref="WcFilters"/>. The compaction logic is a pure function of raw <c>wc</c>
...
/// </summary>
public sealed class WcFiltersTests
{
    // ---- DetectMode ----

    [Fact]
    public void DetectMode_NoFlags_Full() =>
        Assert.Equal(WcFilters.WcMode.Full, WcFilters.DetectMode(new[] { "file.py" }));

    [Fact]
    public void DetectMode_Lines() =>
        Assert.Equal(WcFilters.WcMode.Lines, WcFilters.DetectMode(new[] { "-l", "file.py" }));

    [Fact]
    public void DetectMode_Words() =>
        Assert.Equal(WcFilters.WcMode.Words, WcFilters.DetectMode(new[] { "-w", "file.py" }));

    [Fact]
    public void DetectMode_Bytes() =>
        Assert.Equal(WcFilters.WcMode.Bytes, WcFilters.DetectMode(new[] { "-c", "file.py" }));

    [Fact]
    public void DetectMode_Chars() =>
        Assert.Equal(WcFilters.WcMode.Chars, WcFilters.DetectMode(new[] { "-m", "file.py" }));

    [Fact]
    public void DetectMode_CombinedFlags_Mixed() =>
        Assert.Equal(WcFilters.WcMode.Mixed, WcFilters.DetectMode(new[] { "-lw", "file.py" }));

    [Fact]
    public void DetectMode_SeparateFlags_Mixed() =>
        Assert.Equal(WcFilters.WcMode.Mixed, WcFilters.DetectMode(new[] { "-l", "-w", "file.py" }));

    [Fact]
    public void DetectMode_NonCountFlagOnly_Full() =>
        // A flag with no l/w/c/m chars (e.g. --files0-from style) leaves flag_count 0.
        Assert.Equal(WcFilters.WcMode.Full, WcFilters.DetectMode(new[] { "-L", "file.py" }));
    ...
    public void FilterWcOutput_SingleFileFull()
    {
        ...
        Assert.Equal("30L 96W 978B", WcFilters.FilterWcOutput(raw, WcFilters.WcMode.Full));
    }
    ...
    public void FilterWcOutput_SingleFileLinesOnly()
    {
        ...
        Assert.Equal("30", WcFilters.FilterWcOutput(raw, WcFilters.WcMode.Lines));
    }
    ...
    public void FilterWcOutput_SingleFileWordsOnly()
    {
        ...
        Assert.Equal("96", WcFilters.FilterWcOutput(raw, WcFilters.WcMode.Words));
    }
    ...
    public void FilterWcOutput_OracleLinesOnly()
    {
        ...
        Assert.Equal("72", WcFilters.FilterWcOutput(raw, WcFilters.WcMode.Lines));
    }
    ...
    public void FilterWcOutput_OracleFull()
    {
        ...
        Assert.Equal("505L 2820W 22746B", WcFilters.FilterWcOutput(raw, WcFilters.WcMode.Full));
    }
    ...
    public void FilterWcOutput_MultiFileLines()
    {
        ...
        Assert.Equal("30 main.rs\n50 lib.rs\nΣ 80", WcFilters.FilterWcOutput(raw, WcFilters.WcMode.Lines));
    }
    ...
    public void FilterWcOutput_MultiFileFull()
    {
        ...
        Assert.Equal(
            ...
            WcFilters.FilterWcOutput(raw, WcFilters.WcMode.Full));
    }

    [Fact]
    public void FilterWcOutput_Empty() =>
        Assert.Equal(string.Empty, WcFilters.FilterWcOutput(string.Empty, WcFilters.WcMode.Full));
    ...
    public void FilterWcOutput_MissingFile_EmptyStdout() =>
        ...
        Assert.Equal(string.Empty, WcFilters.FilterWcOutput(string.Empty, WcFilters.WcMode.Lines));

    // ---- FindCommonPrefix / StripPrefix ----

    [Fact]
    public void FindCommonPrefix_ShallowShared() =>
        Assert.Equal("src/", WcFilters.FindCommonPrefix(new[] { "src/main.rs", "src/lib.rs", "src/utils.rs" }));

    [Fact]
    public void FindCommonPrefix_None() =>
        Assert.Equal(string.Empty, WcFilters.FindCommonPrefix(new[] { "main.rs", "lib.rs" }));

    [Fact]
    public void FindCommonPrefix_Deep() =>
        Assert.Equal("src/cmd/", WcFilters.FindCommonPrefix(new[] { "src/cmd/wc.rs", "src/cmd/ls.rs" }));

    [Fact]
    public void FindCommonPrefix_SinglePath_Empty() =>
        Assert.Equal(string.Empty, WcFilters.FindCommonPrefix(new[] { "src/main.rs" }));

    [Fact]
    public void FindCommonPrefix_DivergentSubdirs_ClimbsToShared() =>
        Assert.Equal("src/", WcFilters.FindCommonPrefix(new[] { "src/a/x.rs", "src/b/y.rs" }));

    [Fact]
    public void StripPrefix_Present() =>
        Assert.Equal("main.rs", WcFilters.StripPrefix("src/main.rs", "src/"));

    [Fact]
    public void StripPrefix_EmptyPrefix_ReturnsPath() =>
        Assert.Equal("main.rs", WcFilters.StripPrefix("main.rs", string.Empty));

    [Fact]
    public void StripPrefix_NonMatching_ReturnsPath() =>
        Assert.Equal("main.rs", WcFilters.StripPrefix("main.rs", "src/"));
}
