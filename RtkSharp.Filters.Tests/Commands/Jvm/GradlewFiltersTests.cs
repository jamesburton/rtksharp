...
/// covering the build/test/connected/lint/dependencies filters, the fixture-based token-savings
/// assertions, and the edge cases. Task-detection and dispatch-level tests remain in
/// <c>RtkSharp.Tests.Commands.Jvm.GradlewCommandTests</c>.
/// </summary>
public sealed class GradlewFiltersTests
{
