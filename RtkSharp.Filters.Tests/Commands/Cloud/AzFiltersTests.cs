...
/// <summary>
/// Covers <see cref="AzFilters"/>'s pure filter/redaction logic. Unlike <c>AwsFiltersTests</c>, there
...
/// (<c>c83a19df-6be1-4eba-9505-9ab469177af5</c>), not synthetic data. <c>AzCommand</c>-level
/// dispatch tests (<c>RunAsync_*</c>) stay in <c>RtkSharp.Tests.Commands.Cloud.AzCommandTests</c>.
/// </summary>
public sealed class AzFiltersTests
{
