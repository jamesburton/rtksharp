...
public class PsqlFiltersTests
{
    ...
    public void FilterTable_BasicTableFormat_ProducesTabSeparatedRows()
    {
        ...
        var result = PsqlFilters.FilterTable(input);
    ...
    public void FilterExpanded_BasicExpandedFormat_ProducesOneLinerRecords()
    {
        ...
        var result = PsqlFilters.FilterExpanded(input);
    ...
    {
        var input = " id | name\n----+------\n  1 | foo\n(1 row)\n";
        Assert.True(PsqlFilters.IsTableFormat(input));
    }

    [Fact]
    public void IsTableFormat_RejectsPlainOutput()
    {
        Assert.False(PsqlFilters.IsTableFormat("COPY 5\n"));
        Assert.False(PsqlFilters.IsTableFormat("SET\n"));
    }
    ...
    {
        var input = "-[ RECORD 1 ]----\nid | 1\nname | foo\n";
        Assert.True(PsqlFilters.IsExpandedFormat(input));
    }
    ...
    {
        var input = " id | name\n----+------\n  1 | foo\n";
        Assert.False(PsqlFilters.IsExpandedFormat(input));
    }
    ...
    {
        var result = PsqlFilters.FilterPsqlOutput("");
    ...
    {
        var input = "COPY 5\n";
        var result = PsqlFilters.FilterPsqlOutput(input);
        Assert.Equal("COPY 5\n", result);
    }
