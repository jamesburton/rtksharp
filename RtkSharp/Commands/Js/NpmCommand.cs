...
public static class NpmCommand
{
    ...
    /// <summary>
    /// Filters npm/npx run output. Delegates to <see cref="NpmFilters.FilterNpmOutput"/> (moved to
    /// <c>RtkSharp.Filters</c> in Task 7 of the filters-library extraction — pure text filtering, no
    /// process execution or file I/O).
    /// </summary>
    ...
    internal static string FilterNpmOutput(string output) => NpmFilters.FilterNpmOutput(output);
}
