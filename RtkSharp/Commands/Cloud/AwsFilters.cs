...
internal static class AwsFilters
{
    ...
    /// <summary>
    /// Parse a JSON string and return compact representation with values preserved. Long strings are
    /// truncated, arrays are summarized. Faithful port of <c>json_cmd::filter_json_compact</c> /
    /// <c>compact_json</c> (<c>src/cmds/system/json_cmd.rs</c>:91-178), used by <c>run_generic</c> for
    /// any AWS subcommand without a specialized filter.
    /// </summary>
