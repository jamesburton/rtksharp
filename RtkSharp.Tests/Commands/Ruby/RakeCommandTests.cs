...
/// (19 tests covering <c>filter_minitest_output</c>, <c>parse_minitest_summary</c>,
/// <c>select_runner</c>, and <c>looks_like_test_path</c>).
/// </summary>
public sealed class RakeCommandTests
{
    ...
    public void FilterMinitestAllPass()
    {
        ...
        var result = RakeCommand.FilterMinitestOutput(output);
    ...
    {
        var result = RakeCommand.FilterMinitestOutput("");
    ...
    {
        Assert.Equal((8, 9, 0, 0, 0), RakeCommand.ParseMinitestSummary("8 runs, 9 assertions, 0 failures, 0 errors, 0 skips"));
        Assert.Equal((5, 4, 1, 1, 2), RakeCommand.ParseMinitestSummary("5 runs, 4 assertions, 1 failures, 1 errors, 2 skips"));
        // minitest-reporters uses "tests" instead of "runs".
        Assert.Equal((57, 378, 0, 0, 0), RakeCommand.ParseMinitestSummary("57 tests, 378 assertions, 0 failures, 0 errors, 0 skips"));
    }
