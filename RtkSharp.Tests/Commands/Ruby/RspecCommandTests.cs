...
/// (28 tests covering <c>filter_rspec_output</c>, <c>filter_rspec_text</c>, <c>strip_noise</c>, and
/// the <c>has_format</c> flag-detection expression used by <see cref="RspecCommand.RunAsync"/>).
/// </summary>
