...
public sealed class NpmCommandTests
{
    ...
    // -----------------------------------------------------------------------
    // FilterNpmOutput now lives in RtkSharp.Filters.Commands.Js.NpmFilters (Task 7 of the
    // filters-library extraction) - see NpmFiltersTests in RtkSharp.Filters.Tests.
    // -----------------------------------------------------------------------
